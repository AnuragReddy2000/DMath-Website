    ...
    render(){
        return(
            <div style={{width: '100%'}}>
                ...
                <TableView title={'B.TECH 2019 CURRICULUM'} speaker='Faculty Advisor:  Dr. Sukumar D' link='/pdfs/BtechCurriculum2017.pdf' linkText='Link to the Curriculum'/>
                <TableView title={'B.TECH 2020 CURRICULUM'} speaker='Faculty Advisor:  Dr. Neeraj Kumar' link='/pdfs/BtechCurriculum2017.pdf' linkText='Link to the Curriculum'/>
                ...
                <TableView title={'M.SC 2020 CURRICULUM'} speaker='Faculty Advisor:  Dr. Satya Prakash Singh' link='/pdfs/BtechCurriculum2017.pdf' linkText='Link to the Curriculum'/>
            </div>
        )
    }
}
