import FacultyInfoModel from './FacultyInfoModel';
...
export const FacultyDataList: Array<{name: string, data: FacultyInfoModel}>= [
    ...
    },
    {
        ...
        data: new FacultyInfoModel('Dr. Neeraj Kumar', 'Assistant Professor', Neeraj, 'Commutative Algebra', ' neeraj@math.iith.ac.in', 'C-531', 'https://iith.ac.in/~neeraj/')
    },
    {
